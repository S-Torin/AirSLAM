...
class YoloSegmentor {
 public:
  YoloSegmentor();
  YoloSegmentor(const YoloSegmentorConfig& config);
  ~YoloSegmentor();
 ...
 private:
  ...
  bool onnx2engine(std::string onnx_path, std::string engine_path) const;
...
typedef std::shared_ptr<YoloSegmentor> YoloSegmentorPtr;
